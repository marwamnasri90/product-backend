...
exports.statistique = async  (req, res) => {
   ...
   const entity= await Categorie.findById(req.pars.categorie)
    ...
    const promise = new Promise(async (resolve, reject) => {
      ...
      const products=  await  Product.find({ created: { $lte: mois.end, $gte: mois.start }, categorie: req.parms.categorie})
